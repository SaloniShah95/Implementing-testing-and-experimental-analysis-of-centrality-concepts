...
#Computes betweennnes centrality and returns a dictionary with key=node id value=betwenness value
...
#Check if format of input file is correct
def sanityCheck(filename):
    ...
    if sanityCheck:    
        ...
        if sanityCheck:
            return computeCentrailty(Vertices,Edges)